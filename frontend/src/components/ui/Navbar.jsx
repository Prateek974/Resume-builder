    ...
    return (
        <nav className="bg-white/80 backdrop-blur-md border-b border-zinc-200 sticky top-0 z-50 w-full font-sans">
            ...
            <div className="max-w-7xl mx-auto h-14 flex justify-between items-center px-4">
                ...
                {/* 1. LOGO SECTION - Swapped Blue for Greptile Green */}
                ...
                {/* 2. NAVIGATION SECTION - Underline now in Brand Green */}
                <div className="hidden md:flex gap-6 text-zinc-500 text-[14px] font-medium">
                    <a href="#" className="text-zinc-900 relative after:absolute after:bottom-[-18px] after:left-0 after:w-full after:h-[2px] after:bg-[#009245] transition-colors">
                        Templates
                    </a>
